...
import com.magicFilter.magic_filters.utils.DisplayUtils;
...
public class OverCameraView extends AppCompatImageView {
    ...
    public void setTouchFoucusRect(Camera camera, Camera.AutoFocusCallback autoFocusCallback, float x, float y) {
        ...
        //对焦光感区域
        int left = touchFocusRect.left * 2000 / DisplayUtils.getScreenWidth(context) - 1000;
       // int top = touchFocusRect.top * 2000 / getWindowHeight(context) - 1000;
        int right = touchFocusRect.right * 2000 / DisplayUtils.getScreenWidth(context) - 1000;
      //  int bottom = touchFocusRect.bottom * 2000 / getWindowHeight(context) - 1000;

        int top = touchFocusRect.top * 2000 / height - 1000;
        int bottom = touchFocusRect.bottom * 2000 / height - 1000;
